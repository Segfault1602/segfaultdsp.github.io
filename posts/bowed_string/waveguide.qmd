...
![Block diagram of the waveguide gate. The allpass interpolator were change to linear interpolator and the coefficient were changed to conserve energy through the system.](../assets/waveguide/waveguide_gate_fig.png)
